package com.common.utils.jwt.secret;
...
/**
 * @programs: warehouse-manage-platform
 * @description: RSA加密解密工具类
 * @author: sff
 * @create: 2020-05-19 10:53
 */
public class RSAUtils {
    ...
    public static String encryptByPrivateKey(String content, String privateKey) throws Exception {
        return new String(Base64.getEncoder().encode(encryptByPrivateKey(content.getBytes(CHARSET), getPrivateKey(privateKey))), CHARSET);
    }

    public static String encryptByPrivateKey(String content) throws Exception {
        return new String(Base64.getEncoder().encode(encryptByPrivateKey(content.getBytes(CHARSET))), CHARSET);
    }
