...
public class invoiceController {
    ...
    public YunResult find(@RequestBody JSONObject jsonObject){
        ...
        Page page = invoiceService.findByMany(companyId,stime, etime, status,buyerName, productName, orderId, pageNum, pageRow);
        ...
        if ((!invoice.getOrderId().equals(""))){
            ...
            if(invoice.getOrderType()==0){
                ...
                if ((byId.isPresent()==false)||(byId1.isPresent()==false)){
                    ...
                    saleAmount.setCompanyId(companyId);
                    saleAmount1.setCompanyId(companyId);
                    saleAmountRepository.save(saleAmount);
                    ...
                    financialForm.setCompanyId(companyId);
                    financialForm1.setCompanyId(companyId);
                    financialFormRepository.save(financialForm);
