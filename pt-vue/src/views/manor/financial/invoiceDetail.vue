  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-form
        ...
        label-width="130px"
        style="width: 1000px;height:650px; margin-left:200px;"
         :rules="rules"
      >    
      ...
      <el-row>
        ...
        <el-col :span="12"><div  >
          ...
          <div v-text="tempInvoice.checkTime" align="left"></div>
      </el-form-item>
          </div></el-col>
      </el-row>
...
<script>
import {getParams } from "@/api/manor/financial/financialForm";
  ...
  methods: {
    ...
    getPrevious(){
        this.api({
          ...
          method:"get",
          params:{
           id:this.tempInvoice.previousId
           }
        }).then(data => {
    ...
    back(){
     this.$router.push({path:'/financialForm'});
    },
