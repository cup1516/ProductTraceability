<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" prop="reviewerId" label="审批人" width="150"></el-table-column>
...
<script>
import { list ,toCheck,backFromCheck,invalid,find} from "@/api/manor/sale/myInvoice";
...
export default {
  ...
  detail($index){
      this.$router.push({path:'/detail/myInvoiceDetail',
