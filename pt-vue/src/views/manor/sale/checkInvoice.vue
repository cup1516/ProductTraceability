<template>
  <div class="app-container">
    ...
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true"  size="small" label-width="140px" :model="tempFind">
          ...
          <el-select  v-model="tempFind.staff" placeholder="请选择创建人"  style="width:170px">
           <el-option
    ...
    >
      ...
      <el-table-column align="center" prop="orderCreator" label="开票人" width="100"></el-table-column>
...
<script>
import { list,pass ,checkBack,getStaff,find} from "@/api/manor/sale/checkInvoice";
  ...
  methods: {
    ...
    getStaff(){
     ...
     pass($index) {
      ...
      pass(this.tempInvoice).then(response => {  
      this.getList();
        }
      );
    },
    ...
    checkBack($index) {
      this.tempInvoice.orderId = this.list[$index].orderId;
      checkBack(this.tempInvoice).then(response => {  
      this.getList();
        }
      );
    },
    ...
    detail($index){
      this.$router.push({path:'/detail/checkInvoiceDetail',
