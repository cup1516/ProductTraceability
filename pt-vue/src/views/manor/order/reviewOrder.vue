<template>
  <div class="app-container">
    ...
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true"  size="small" label-width="140px" :model="tempFind">
          ...
          <el-select  v-model="tempFind.creatorName" placeholder="请选择创建人"  style="width:170px">
           <el-option
    ...
    >
      ...
      <el-table-column align="center" prop="buyerName" label="企业名" width="160"></el-table-column>
      <el-table-column align="center" prop="creatorName" label="开票人" width="100"></el-table-column>
      ...
      <el-table-column align="center" prop="checkStatus" label="确认状态" width="100">
        <template slot-scope="scope">
...
import { list,pass ,reviewBack,backToCheck,toCheck,find } from "@/api/manor/order/reviewOrder";
...
export default {
  ...
  methods: {
    ...
    reviewBack($index) {
      this.tempOrder.orderId = this.list[$index].orderId;
      reviewBack(this.tempOrder).then(response => {  
      this.getList();
        }
      );
    },
    ...
    toCheck($index){
      this.tempOrder.orderId = this.list[$index].orderId;
      toCheck(this.tempOrder).then(response =>{
        this.getList();
      })
    },
     ...
     backToCheck($index){
      this.tempOrder.orderId = this.list[$index].orderId;
      backToCheck(this.tempOrder).then(response =>{
        this.getList();
      })
    },
