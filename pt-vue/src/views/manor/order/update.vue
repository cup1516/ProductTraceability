...
import {getParams,update} from "@/api/manor/order/update"
    ...
    getParams() {
      ...
      getParams(
        ...
        const data = response.data
          ...
          var arr = data.productBatch.split("-");
          this.tempOrder.findFarmlandRegionId = arr[0];
          this.tempOrder.plantingBatch = arr[1];
