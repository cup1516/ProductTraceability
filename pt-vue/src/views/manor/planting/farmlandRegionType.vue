<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" prop="name" label="区块类型" width="995"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form
        class="small-space"
        :model="tempFarmlandRegionType"
        label-position="left"
        label-width="90px"
        style="width: 500px; margin-left:50px;"
      >
        <!-- <el-form-item label="id" v-if="dialogStatus=='update'">
          <el-input type="text" v-model="tempFarmlandRegionType.id" :disabled="true">
          </el-input>
        </el-form-item> -->

        <el-form-item label="区块类型：">
          <el-input type="text" v-model="tempFarmlandRegionType.name"></el-input>
        </el-form-item>
...
<script>
import { list,create,isDelete,update } from "@/api/manor/planting/farmlandRegionType";
...
export default {
  ...
  methods: {
    ...
    isDelete($index) {
      this.tempFarmlandRegionType.id = this.list[$index].id;
      isDelete(
        this.tempFarmlandRegionType
      ).then(response =>{
        this.getList();
