      ...
      <el-table v-loading="loading" :data="tableData" style="width: 100%" align='center'>
        ...
        <el-table-column prop="operation" align='center' label="操作">
          <template slot-scope='scope'>
            ...
            <el-button v-if="scope.row.state === '0'" type="danger" icon='edit' size="mini" @click='recallOtherout(scope.row)'>
              撤回
            </el-button>
          </template>
        </el-table-column>
...
import { describeMineFuzzy, updateOtheroutByPrimaryKey } from '../../api/otherout/otherout.js'
