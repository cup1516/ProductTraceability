    ...
    <div class="menu_content">
      <div class="form">
        <el-form ref="form" :model="form" :label-width="dialog.formLabelWidth" style="margin:10px;width:auto;">
          <el-row>
            <el-col :span="12">
              <el-form-item prop='otheroutNo' label="工单编号:">
                <span>{{form.otheroutNo}}</span>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item prop='otheroutNo' label="出库负责人:">
...
<script>
import {describeFuzzy} from '../../api/otherout/otheroutDetail.js'
import pagination from '@/views/warehouse/components/pagination/Index'

export default {
  name: 'OtheroutDetailDialog',
  data: function () {
    return {
