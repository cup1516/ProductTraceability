<template>
  <div class="fillcontain">
    ...
    <div class="table_container">
      ...
      <storeDetailDialog v-if="storeDetailDialog.show" :isShow="storeDetailDialog.show" :dialogRow="storeDetailDialog.dialogRow" @closeDialog="hideAddStoreDialog"> </storeDetailDialog>
...
export default {
  ...
  methods: {
    ...
    onDetailStore: function (row) {
      console.log('查看详情')
      this.storeDetailDialog.dialogRow = {...row}
      this.storeDetailDialog.show=true
    }
  },
  created: function () {
    this.getStoreList()
  },
  components: {pagination, StoreFunctionDialog,storeDetailDialog}
}
</script>
