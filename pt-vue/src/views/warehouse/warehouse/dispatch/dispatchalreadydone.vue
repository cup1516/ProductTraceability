  ...
  <div class="fillcontain">
    ...
    <div class="table_container">
      <el-table v-loading="loading" :data="tableData" style="width: 100%" align='center'>
        ...
        <el-table-column prop="dispatchNo" label="出库单编号" align='center'></el-table-column>
...
import { describeAlreadDoneFuzzy } from '../../api/dispatch/dispatch.js'
import storage, {USER} from '../../utils/storage'
import dispatchDetailDialog from './DispatchDetailDialog'
export default {
  name: 'dispatchalreadydone',
  data () {
    return {
      idFlag: false,
  ...
  components: {dispatchDetailDialog, pagination}
}
</script>
