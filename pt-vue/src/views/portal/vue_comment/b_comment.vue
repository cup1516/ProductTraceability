<template>
    <div class="b_comment_bg" style="width: 100%;flex: 1;padding-bottom: 40px;padding-top: 10px">
      <el-card >
        <div class="comment-content">
          <div class="comment-head">
            <h3 class="comment_title" style="text-align: center">评论意见</h3>
            <div class="area-bg">
            ...
            <div class="submit-bg">
              ...
              >
                ...
                <el-button @click="emoji_focus()" slot="reference" size="small"><i
              ...
              <div v-if="if_not_logined_status" class="nickname_area"
                ...
                <span style="user-select:none;">用户名：</span><!--id可删去-->
      ...
      mounted () {
        ...
        methods: {
            ...
            emoji_focus() {
                ...
                console.log(this.emoji_visible)
